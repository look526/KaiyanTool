...
import { parseScript, saveScript, getScript, continueScript, rewriteScript, optimizeScene, parseScriptWithAI, optimizeSceneContent } from '../controllers/script.controller';
