          ...
          <div style={{ maxWidth: '800px', margin: '0 auto' }}>
                    ...
                    >
                      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '12px' }}>
                        <div style={{
                          ...
                          <IconComponent style={{ width: '20px', height: '20px', color: isSelected ? 'var(--accent-on)' : 'var(--text-secondary)' }} />
                        </div>
                        {isSelected && (
            ...
            <Card style={{ padding: '32px', marginBottom: '24px' }}>
              ...
              <div style={{
                ...
                当前强调色：<span style={{ color: accentColor, fontWeight: '600' }}>{accentColor}</span>
              </div>
            </Card>
