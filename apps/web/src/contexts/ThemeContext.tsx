...
export const ThemeProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const [accentColor, setAccentColorState] = useState<string>(() => {
    return localStorage.getItem('kaiyan-accent-color') || '#6366f1';
  });
  ...
  const applyTheme = (effectiveTheme: 'light' | 'dark') => {
    ...
    if (effectiveTheme === 'dark') {
      root.style.setProperty('--bg-base', '#05050a');
      root.style.setProperty('--bg-surface', '#0a0a12');
      root.style.setProperty('--bg-elevated', '#0f0f1a');
      root.style.setProperty('--bg-page', '#050505');
      root.style.setProperty('--bg-sidebar', 'rgba(5, 5, 10, 0.95)');
      ...
      root.style.setProperty('--bg-header', 'rgba(5, 5, 10, 0.95)');
      root.style.setProperty('--text-primary', '#fafafa');
      root.style.setProperty('--text-secondary', 'rgba(250, 250, 250, 0.6)');
      root.style.setProperty('--text-tertiary', 'rgba(250, 250, 250, 0.4)');
      root.style.setProperty('--text-muted', 'rgba(250, 250, 250, 0.4)');
      root.style.setProperty('--text-placeholder', 'rgba(250, 250, 250, 0.35)');
      root.style.setProperty('--border-primary', 'rgba(255, 255, 255, 0.06)');
      root.style.setProperty('--border-secondary', 'rgba(255, 255, 255, 0.04)');
      ...
      root.style.setProperty('--accent-text', '#a78bfa');
      ...
      root.style.setProperty('--nav-active-bg', 'rgba(139, 92, 246, 0.15)');
      ...
      root.style.setProperty('--shadow-lg', '0 8px 24px rgba(0, 0, 0, 0.15)');
      root.style.setProperty('--shadow-xl', '0 20px 40px rgba(0, 0, 0, 0.2)');
      ...
      root.style.setProperty('--shadow-card-hover', '0 8px 32px rgba(0, 0, 0, 0.12), 0 0 30px rgba(139, 92, 246, 0.1)');
      root.style.setProperty('--shadow-glow', '0 0 80px rgba(139, 92, 246, 0.05), 20px 0 60px rgba(0, 0, 0, 0.3)');
